      ...
      <div className="flex gap-5 mt-8">
        ...
        <div className="w-7/12">
          ...
          <div className="mt-4">
            <button
              type="button"
              className="w-full text-white bg-[#42446e] hover:bg-[#42446e] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2focus:outline-none"
            >
              Send message
            </button>
          </div>
